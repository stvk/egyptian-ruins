		...
		function onPuzzleTouch(e){
			...
			_current = checkPieceClicked();
			
			//createTitle("Touch x: " + touch.pageX + ", y: " + touch.pageY);
            ...
            if(_currentPiece != null){
                ...
                _stage.restore();
				_canvas.addEventListener("touchmove", updatePuzzleTouched, false);
        ...
        function onPuzzleClick(e){
            ...
            if(_currentPiece != null){
                ...
                _stage.drawImage(_img, _currentPiece.sx, _currentPiece.sy, _pieceWidth, _pieceHeight, _mouse.x - (_pieceWidth / 2), _mouse.y - (_pieceHeight / 2), _pieceWidth, _pieceHeight);
                _stage.restore();
                document.onmousemove = updatePuzzleClicked;
		...
		function updatePuzzleTouched (e) {
			var touch = event.targetTouches[0];
		...
		function updatePuzzleClicked (e) {
            if(e.layerX || e.layerX == 0){
                _mouse.x = e.layerX - _canvas.offsetLeft;
                _mouse.y = e.layerY - _canvas.offsetTop;
            }
